...
if __name__ == '__main__':
    ...
    zebraPrinter.print_text(
        ["It's possible to write", "messages as a list of",
        "strings although it", "would be better if any",
        "length string could be", "given and it would be",
        "split up automatically.", "We're not there yet."],
        font_size=1, override_exit=True)
