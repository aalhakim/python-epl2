...
if __name__ == '__main__':
    ...
    for n in range(quantity):
        ...
        if last_label is True and (n % SCROLL_COLUMNS != max_column) is False:
            ...
            zebraPrinter.commander.encode_qr_code(serial_number, start_x=(n*80)+10, start_y=10)
        else:
            zebraPrinter.commander.encode_aztec_code(serial_number, start_x=(n*80)+10, start_y=10)
